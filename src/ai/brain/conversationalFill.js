    ...
    messages: [
      {
        ...
        content: [
          ...
          '',
          'Ejemplos:',
          '- Si instrumento_notarial = "simple" o "ninguno" → notario_nombre, notaria_numero, plaza_notarial, libro_volumen, texto_certificacion_notarial, fecha_otorgamiento_notarial = "N/A"',
          '- Si un campo booleano de tipo "con_X" = false → los campos relacionados con X = "N/A"',
          '- Aplica la misma lógica para cualquier campo condicional que detectes',
          '',
